...
class pfp_footprint_ui(QtGui.QDialog):
    def __init__(self, parent=None):
        super(pfp_footprint_ui, self).__init__(parent)
        self.resize(400, 236)
        self.setWindowTitle("FootPrint calculation")
        self.RunButton = QtGui.QPushButton(self)
        self.RunButton.setGeometry(QtCore.QRect(20, 200, 93, 27))
        self.RunButton.setText("Run")
        self.DoneButton = QtGui.QPushButton(self)
        ...
        self.radioButton_Annual = QtGui.QRadioButton(self)
        self.radioButton_Annual.setGeometry(QtCore.QRect(20, 140, 110, 22))
        self.radioButton_Annual.setText("Annual")
        self.radioButton_Annual.setChecked(True)
        self.radioButton_Monthly = QtGui.QRadioButton(self)
        self.radioButton_Monthly.setGeometry(QtCore.QRect(20, 110, 110, 22))
        self.radioButton_Monthly.setText("Monthly")
        self.radioButton_Monthly.setChecked(True)
        self.radioButton_Daily = QtGui.QRadioButton(self)
        self.radioButton_Daily.setGeometry(QtCore.QRect(130, 140, 110, 22))
        self.radioButton_Daily.setText("Daily")
        self.radioButton_Daily.setChecked(True)
        self.radioButton_Hourly = QtGui.QRadioButton(self)
        self.radioButton_Hourly.setGeometry(QtCore.QRect(130, 110, 110, 22))
        self.radioButton_Hourly.setText("Hourly")
        self.radioButton_Hourly.setChecked(True)
        self.radioButton_Manual = QtGui.QRadioButton(self)
        self.radioButton_Manual.setGeometry(QtCore.QRect(240, 140, 110, 22))
        self.radioButton_Manual.setText("Manual")
        self.radioButton_Manual.setChecked(True)
        self.radioButton_Single = QtGui.QRadioButton(self)
        self.radioButton_Single.setGeometry(QtCore.QRect(240, 110, 110, 22))
        self.radioButton_Single.setText("Single")
        self.radioButton_Single.setChecked(True)
        self.radioButtons = QtGui.QButtonGroup(self)
        self.radioButtons.addButton(self.radioButton_Annual)
        self.radioButtons.addButton(self.radioButton_Monthly)
        self.radioButtons.addButton(self.radioButton_Daily)
        self.radioButtons.addButton(self.radioButton_Hourly)
        self.radioButtons.addButton(self.radioButton_Manual)
        self.radioButtons.addButton(self.radioButton_Single)
        ...
        self.label_DataEndDate_value.setText("YYYY-MM-DD HH:mm")
        # connect signals to slots
        self.RunButton.clicked.connect(lambda:pfp_footprint.footprint_run_gui(self))
        self.DoneButton.clicked.connect(lambda:pfp_footprint.footprint_done(self))
        self.QuitButton.clicked.connect(lambda:pfp_footprint.footprint_quit(self))
